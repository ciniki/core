...
// <rsp stat="ok" />
//
function ciniki_core_tagAdd($ciniki, $module, $tnid, $history_table, $table, $key_name, $key_value, $type, $name) {
    //
    ...
    if( $rc['stat'] == 'ok' && $rc['num_affected_rows'] == 1 ) {
        ...
        $rc = ciniki_core_dbAddModuleHistory($ciniki, $module, $history_table, $tnid, 1, $table, $tag_id, 'name', $name);
    }
