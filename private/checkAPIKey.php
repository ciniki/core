...
function ciniki_core_checkAPIKey($ciniki) {
    ...
    if( !isset($ciniki['request']['api_key']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.core.22', 'msg'=>'Internal Error', 'pmsg'=>"ciniki_core_checkAPIKey called before ciniki_core_init."));
    }
    ...
    return ciniki_core_dbRspQuery($ciniki, $strsql, 'ciniki.core', 'api_key', '', array('stat'=>'fail', 'err'=>array('code'=>'ciniki.core.23', 'msg'=>'Invalid API Key')));
}
?>
