...
// <rsp stat="ok" />
//
function ciniki_core_tagDelete($ciniki, $module, $tnid, $history_table, $table, $key_name, $key_value, $type, $name) {
    //
    ...
    $rc = ciniki_core_dbAddModuleHistory($ciniki, $module, $history_table, $tnid, 3, $table, $tag_id, 'type', $type);
    $rc = ciniki_core_dbAddModuleHistory($ciniki, $module, $history_table, $tnid, 3, $table, $tag_id, 'name', $name);
