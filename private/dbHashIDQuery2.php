...
//
function ciniki_core_dbHashIDQuery2(&$ciniki, $strsql, $module, $col_x_container, $col_x_name, $col_y_container, $col_y_name) {
    //
    ...
    if( $result == false ) {
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'102', 'msg'=>'Database Error', 'pmsg'=>mysqli_error($dh)));
    }
    ...
    while( $row = mysqli_fetch_assoc($result) ) {
        ...
        //
        if( $row[$col_x_name] != $prev_col_x_value ) {
            $num_col_x++;
            $num_col_y=0;
            $rsp[$col_x_container][$num_col_x] = array($col_x_name=>array('id'=>$row[$col_x_name], $col_y_container=>array()));
        }
        ...
        $prev_col_x_value = $row[$col_x_name];
    }
